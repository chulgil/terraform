...
module "eks" {
  ...
  # Note: Bastion access is configured separately below to avoid dependency issues
...
# Bastion to EKS API Security Group Rule
# Note: Currently not needed because EKS endpoint_public_access = true
# Enable this rule only when endpoint_public_access = false for enhanced security
#
