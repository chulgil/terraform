...
# Note: Bastion access is now handled at the environment level to avoid dependency issues
# variable "bastion_security_group_id" - removed
# variable "enable_bastion_access" - removed
